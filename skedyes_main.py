...
class SkedYesUI(QtGui.QMainWindow):
    ...
    def setFocus(self):
        if(ptcTestIdx.current_idx == ptcTestIdx.HDD_TEST ):
            self.ui.hddStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.USB_TEST ):
            self.ui.usbStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.SMC_TEST ):
            self.ui.smartcardStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.FAN_TEST ):
            self.ui.fanStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.LNB_TEST ):
            self.ui.lnbStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.TUNER_TEST ):
            self.ui.tunerStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.BUTTON_TEST ):
            self.ui.buttonStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.LED_TEST ):
            self.ui.ledStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.IR_TEST ):
            self.ui.irStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.HDCP_PRG ):
            self.ui.hdcpStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
        ...
        if(ptcTestIdx.current_idx == ptcTestIdx.UI_PRG ):
            self.ui.uiUpdateStartButton.setStyleSheet("QPushButton { background-color : yellow; color : black; }");
            self.ui.handleAppSwUpdate.setStyleSheet("QLabel { background-color : orange; color : white; }");


    def clearFocus(self):
        if(ptcTestIdx.current_idx == ptcTestIdx.HDD_TEST ):
            self.ui.hddStartButton.setStyleSheet("none");
            self.ui.labelHddTest.setStyleSheet("none");
        if(ptcTestIdx.current_idx == ptcTestIdx.USB_TEST ):
            self.ui.usbStartButton.setStyleSheet("none");
            self.ui.labelUsbTest.setStyleSheet("none");
        if(ptcTestIdx.current_idx == ptcTestIdx.SMC_TEST ):
            self.ui.smartcardStartButton.setStyleSheet("none");
            self.ui.labelSmartcardTest.setStyleSheet("none");

        if(ptcTestIdx.current_idx == ptcTestIdx.FAN_TEST ):
            self.ui.fanStartButton.setStyleSheet("none");
            self.ui.labelFanTest.setStyleSheet("none");

        if(ptcTestIdx.current_idx == ptcTestIdx.LNB_TEST ):
            self.ui.lnbStartButton.setStyleSheet("none");
            self.ui.labelLnbTest.setStyleSheet("none");

        if(ptcTestIdx.current_idx == ptcTestIdx.TUNER_TEST ):
            self.ui.tunerStartButton.setStyleSheet("none");
            self.ui.labelTunerTest.setStyleSheet("none");

        if(ptcTestIdx.current_idx == ptcTestIdx.VFD_TEST ):
            self.ui.fpStartButton.setStyleSheet("none");
            self.ui.labelFpTest.setStyleSheet("none");

        if(ptcTestIdx.current_idx == ptcTestIdx.BUTTON_TEST ):
            self.ui.buttonStartButton.setStyleSheet("none");
            self.ui.labelButtonTest.setStyleSheet("none");

        if(ptcTestIdx.current_idx == ptcTestIdx.LED_TEST ):
            self.ui.ledStartButton.setStyleSheet("none");
            self.ui.labelLedTest.setStyleSheet("none");
        if(ptcTestIdx.current_idx == ptcTestIdx.IR_TEST ):
            self.ui.irStartButton.setStyleSheet("none");
            self.ui.labelIrTest.setStyleSheet("none");

        if(ptcTestIdx.current_idx == ptcTestIdx.HDCP_PRG ):
            self.ui.hdcpStartButton.setStyleSheet("none");
            self.ui.handleHDCPLabel.setStyleSheet("none");

        if(ptcTestIdx.current_idx == ptcTestIdx.UI_PRG ):
            self.ui.uiUpdateStartButton.setStyleSheet("none");
